...
* Interstellar  - Alpha Centari ~4.2 lightyears away. (Fun fact- the nearest known expolanets are here!)

* Intergalactic - Our nearest neighbor Andromeda is ~2.5 million lightyears away (!!)
...
give ourselves a little speed boost by bumping acceleration up to 12 m/s^2. 1.22g's would
...
just accelerate continuously until we are halfway, then immediatley start decellerating so we 
...
time could we save our explorers for, say the 8 light-year round trip to and from Proxima Centari? Turns out,
...
For travelling to Andromeda, even at 0.9999c we are still talking _thousands_ of years and many
